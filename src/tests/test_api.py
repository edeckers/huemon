...
class TestCachedApi(unittest.TestCase):
    def test_when_cache_not_expired_return_cache(self):
        ...
        api = CachedApi(
            mutable_api, CACHE_VALIDITY_INFINITE_SECONDS, tempfile.mkdtemp()
        )
        ...
        self.assertEqual(
            version_pre, version_pre_recv, "Received version should equal set version"
        )
        self.assertEqual(
            version_pre_recv,
            version_post_recv,
        ...
        self.assertNotEqual(version_pre, version_post, "Set versions should differ")
    ...
    def test_when_cache_expired_return_new_data(self):
        ...
        api = CachedApi(mutable_api, CACHE_VALIDITY_ZERO_SECONDS, tempfile.mkdtemp())
        ...
        self.assertEqual(
            version_post, version_post_recv, "Received version should equal set version"
        )
        self.assertNotEqual(
            version_pre_recv,
            version_post_recv,
